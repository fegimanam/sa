...
local function run(msg, matches)
  if matches[1]:lower() == 'sultan' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "sultan" then -- Put everything you like :)
...
return {
	usage = {
		...
		"stats sultan: Return Users And Groups Stats.",
		},
  patterns = {
    "^([Ss]tats)$",
    "^([Ss]tatslist)$",
    "^([Ss]tats) (group) (%d+)",
    "^([Ss]tats) (sultan)",-- Put everything you like :)
		"^([Ss]ultan)"-- Put everything you like :)
    }, 
  run = run
}
